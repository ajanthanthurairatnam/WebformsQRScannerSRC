...
const qroutputData = document.getElementById("qroutputData");
const btnScanQR = document.getElementById("btn-scan-qr");

const btnCloseQrReader = document.getElementById("btnCloseQrReader");
...
btnCloseQrReader.onclick = () => {
    if (scanning) {
        ...
        if (qrcodeClosecallback) {
            let closeAction = "";
            qrcodeClosecallback(closeAction);
        }
    }   
};
